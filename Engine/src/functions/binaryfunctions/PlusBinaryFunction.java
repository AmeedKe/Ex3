...
public class PlusBinaryFunction extends BinaryExpression {

    public PlusBinaryFunction(Expression left, Expression right) {
        super(left, right);
    }
    ...
    protected EffectiveValue apply(EffectiveValue leftValue, EffectiveValue rightValue) {
        ...
        try {
            ...
            throw new ArithmeticException("Error performing addition: " + e.getMessage());
        }
    }
