...
public class MinusBinaryFunction extends BinaryExpression {

    public MinusBinaryFunction(Expression left, Expression right) {
        super(left, right);
    }
    ...
    protected EffectiveValue apply(EffectiveValue leftValue, EffectiveValue rightValue) {
        ...
        try {
            ...
            throw new ArithmeticException("Error performing subtraction: " + e.getMessage());
        }
    }
