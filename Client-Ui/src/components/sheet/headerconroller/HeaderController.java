...
public class HeaderController {
    ...
    private void handleLoadFileAction() {
        ...
        if (selectedFile != null) {
            loadedFilePathLabel.setText(selectedFile.getAbsolutePath());
            mainController.loadFile(selectedFile);
            enableButtons();
        } else {
            setLoadedFilePathLabel("....xml");
        }
    }
    ...
    public void setLoadedFilePathLabel(String filePath) {
        loadedFilePathLabel.setText(filePath);
    }
